...
fn main() {
    ...
    // Настроим поверхность в соответствии с параметрами окна:
    ...
    // которое будет выполнятся на каждой итерации цикла.
    event_loop.run(move |event, _, control_flow| {
        ...
        *control_flow = ControlFlow::Wait;
        ...
        match event {
                    ...
                    // что RenderPass живёт не дольше, чем CommandEncoder.
                    {
                        let mut rpass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
                            ...
                            color_attachments: &[Some(wgpu::RenderPassColorAttachment {
                                ...
                                ops: wgpu::Operations {
                                    load: wgpu::LoadOp::Clear(wgpu::Color::RED), // Очищаем кадр синим цветом.
            ...
            //     window_id,
            // } if window_id == window.id() => {
            //     if input.virtual_keycode == Some(VirtualKeyCode::PageUp){
            //         println!("Press PageUp");
            //     }
            // }
